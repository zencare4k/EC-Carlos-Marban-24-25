...
var index = require('./format/index.cjs');
...
var namespace$j = require('./hover-card/namespace.cjs');
...
var namespace$y = require('./slider/namespace.cjs');
